...
<h1 class="mb-5">View Reports</h1>
<div class="row">
  @foreach ($reports as $report)
  <div class="col-12 d-flex justify-content-between mb-3 w-100 m-0 px-5 py-2 {{ $report->status == 2 ? 'readed' : '' }}">
    <div class="row w-100"> 
      <div class="col-6 d-flex align-items-center">
        <h4 class="d-flex justify-content-start align-items-center mb-0"><i class="fa fa-share me-3"></i>{{ $report->from }}</h4>
        {{-- {{ $report->about }} <br /> --}}
      </div>
      <div class="col-6 d-flex justify-content-between align-items-center">
        <button class="btn btn-outline-info show-report d-flex align-items-center" type="button" data-bs-toggle="offcanvas"
          data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" data-report="{{ $report }}">
  ...
  <div class="offcanvas-body">
    <div class="row">
      ...
      <div class="col-12 mt-5 d-flex justify-content-around">
        ...
        <form action="" method="POST" id="archivedForm">
          @csrf
          <button type="submit" class="btn btn-danger">Archive <i class="fa fa-archive"></i></button>
        </form>
      </div>
    </div>
  </div>
